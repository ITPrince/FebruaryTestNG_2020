...
public class BasePage {
	...
	public WebDriver initialize_driver (Properties prop) {
		...
		if (browser.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver", "/Users/emir1/Documents/Drivers/chromedriver");
	  ...
	  public Properties initialize_properties(){
		  ...
		  try {
			  FileInputStream ip = new FileInputStream("/Users/emir1/Documents/workspace/FebruaryTestNG2020/"
